\boldchapter{Transcription Initiation}
...
TFIIA and TFIIB are the first factors to make contact with TBP, stabilizing its interaction with DNA.
...
\centering
\includegraphics[width=5.275cm]{figures/introduction/picAssembly} % 5.094cm
