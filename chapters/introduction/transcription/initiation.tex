...
These complexes can be recruited in two ways: through sequence specificity or as a consequence of recruitment of gene-specific transcription factors such as Reb1p, Abf1p, and Rap1p to promoter regions \citep{floer:2010:rscnucleosome, hartley:2009:mechanisms, spain:2014:rsc}.
...
\subsection{Temporal definition: Gene-specific transcription factors}
...
When the RNA-DNA hybrid reaches a length of about 10 nucleotides, the upstream half of the bubble, which now spans 17-18 nucleotides, collapses, suddenly closing \cite{holstege:2997:three}.
